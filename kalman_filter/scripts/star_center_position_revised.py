...
class MarkerProcessor(object):
    def __init__(self, use_dummy_transform=False):
        ...
        self.add_marker_locator(MarkerLocator(0,(0*m_per_tile,0.0**m_per_tile)))
        self.add_marker_locator(MarkerLocator(1,(4*m_per_tile,-3*m_per_tile)))
        self.add_marker_locator(MarkerLocator(2,(-5*m_per_tile,9*m_per_tile)))
        self.add_marker_locator(MarkerLocator(3,(2*m_per_tile,-2*m_per_tile)))
        self.add_marker_locator(MarkerLocator(4,(4*m_per_tile,0*m_per_tile)))
        self.add_marker_locator(MarkerLocator(5,(3*m_per_tile,-5*m_per_tile)))
